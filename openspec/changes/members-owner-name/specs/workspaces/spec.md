...
the member's real name and role. The workspace owner's row SHALL show their real name, the same way
every other member's row does — never a fallback to their email address or any other identifier.

#### Scenario: Owner's row shows their real name
