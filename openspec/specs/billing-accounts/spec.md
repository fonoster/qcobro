# billing-accounts Specification

## Purpose

The payer side of billing: the BillingAccount entity, its Stripe customer/
subscription lifecycle (item per workspace), plan upgrades and downgrades,
cycle turnover on invoice payment, dunning, and enterprise collection.
