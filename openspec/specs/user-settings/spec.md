...
`userRef`, never in the Identity service. Holds the user's console language and appearance
preferences and provides their default/seed behavior and read/update operations.
