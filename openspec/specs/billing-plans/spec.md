...
The sellable plan catalog and its pricing rules: how plans, per-meter rates,
telecom billing increments, and micro-unit money precision are defined in
configuration and resolved when usage is priced.
