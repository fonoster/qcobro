...
| 6   | Archive         | skipped | Campaigns + campaign-triggers shipped. Remaining delta specs (agent-templates, web-console, account-contact-log, portfolio-accounts) belong to future /ps:ship passes. Archive when those are done.                                                                                                                                                                     |
