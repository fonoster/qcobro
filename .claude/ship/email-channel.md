...
| 3   | Build           | in-progress | **Group 1 (contracts) done** [1.1–1.5]: `resend` config block, EMAIL in dispatch schema+types (+`subject`, validation), EMAIL agent `systemPrompt`+`maxReplies`, email thread/decision/`EmailClient` types. common builds + apiserver typechecks green (had to regenerate a stale Prisma client). **Next: group 2 (Prisma EmailConfig.systemPrompt/maxReplies + migration), then 3–9.** |
| 4   | Test            | pending     |                                                                                                                                                                                                                                                                                                                                                                                         |
| 5   | Sync            | pending     |                                                                                                                                                                                                                                                                                                                                                                                         |
| 6   | Archive         | pending     |                                                                                                                                                                                                                                                                                                                                                                                         |
