...
| 5   | Sync            | done   | 2026-06-23: created main `openspec/specs/channel-dispatch/spec.md` (3 reqs) + appended "Manual outreach from a customer row" to main web-console. `openspec validate --all` = 18 passed.                                                                                                                                                                               |
| 6   | Archive         | done   | 2026-06-23: archived to `changes/archive/2026-06-23-manual-outreach`. All 3 channels live-verified. SHIPPED.                                                                                                                                                                                                                                                           |
