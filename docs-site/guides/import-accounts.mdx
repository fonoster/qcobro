...
<Frame caption="El importador: elige el archivo CSV y el modo de sincronización.">
  <img src="/images/guides/import-accounts/modal.png" alt="Modal Importar cuentas: archivo CSV seleccionado, conteo de cuentas listas, y los modos Solo agregar nuevas, Agregar y actualizar, y Reemplazar todo." />
</Frame>
