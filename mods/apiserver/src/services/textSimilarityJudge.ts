...
const JUDGE_PROMPT = [
  ...
  "- CONTEXT: known-true facts about the account (name, balances, dates, terms) the agent may",
  "  legitimately mention even when they do not appear in EXPECTED.",
  "",
  "Task:",
  ...
  "   present in CONTEXT. Any such invented detail is a FAIL regardless of intent match — this",
