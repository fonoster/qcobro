...
// The stub simulates the UserSettings column defaults (language "es", theme "system")
// filling any field the upsert `create` omits.
...
describe("getUserSettings", () => {
  ...
  it("seeds a row keyed by userRef (language + theme defaults from the DB) when none exists", async () => {
