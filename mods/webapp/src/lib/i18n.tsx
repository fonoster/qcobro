...
export const messages = {
  en: {
    ...
    "home.contactRate.periodAriaLabel": "Contact rate period",
    // Kept short deliberately: the longer "of accounts reached" clips inside the card's
    // content box. The card's own label already establishes this is a contact rate.
    "home.contactRate.subline": "{contacted} of {total} accounts · {sends} sends",
    "home.contactRate.empty": "No sends in this period",
    "home.contactRate.emptyValue": "—",
    ...
    "resetPassword.error": "Could not reset the password. The link may have expired.",
    "resetPassword.invalidTitle": "Invalid or expired link",
    "resetPassword.invalidSubtitle": "Request a new password reset link.",
    "resetPassword.invalidCta": "Back to forgot password",
    ...
    "billing.subtitle": "Credits, plan, and payment for this workspace.",
    "billing.cycleCredits": "Cycle credits",
    "billing.remaining": "US$ {balance} of US$ {allowance} remaining",
    "billing.renews": "Renews {date}",
    "billing.projectedDays": "\u2248 {days} more days",
    "billing.planAndPayment": "Plan & payment",
    "billing.managePlan": "Manage plan",
    "billing.updatePayment": "Update payment method",
    "billing.viewInvoices": "View invoices",
    "billing.stripeNote": "Invoices and payment methods are managed securely on Stripe.",
    "billing.disabled": "Billing is not enabled on this deployment.",
    "billing.notEnrolled": "This workspace is not on a plan yet.",
    "billing.choosePlan": "Choose a plan",
    "billing.currentPlan": "Current plan",
    "billing.upgradeNow": "Upgrade now",
    "billing.downgrade": "Downgrade",
    "billing.upgradeNote": "Applies immediately \u00b7 prorated credits",
    "billing.downgradeNote": "Applies at the end of the cycle",
    ...
    "billing.paused.exhausted.body":
      "Outreach resumes when the cycle renews \u00b7 or immediately if you upgrade the plan.",
    "billing.paused.exhausted.cta": "Upgrade plan",
    "billing.paused.paymentFailed.title": "Collections paused \u00b7 payment problem",
    "billing.paused.paymentFailed.body":
      "Update the payment method to resume sending \u00b7 no plan change needed.",
    "billing.paused.paymentFailed.cta": "Update payment method",
    ...
    "profile.field.appearance": "Appearance",
    ...
    "profile.password.subtitle": "Must be at least 8 characters.",
    ...
    "profile.password.saveError": "Could not update the password.",
    "profile.password.mismatch": "Passwords don't match.",
    ...
    "members.viewerNotice": "You have view-only access to this workspace's members.",
    ...
    "portfolios.col.lastSynced": "Last synced",
    "portfolios.lastSynced.never": "Never synced",
    ...
    "portfolios.reachOut.whatsAppReadOnly":
      "Meta-approved template with this customer's values filled in. The wording can't be edited.",
    ...
    "agents.form.dtmfSectionDescription":
      "The recipient can press a digit during the call to repeat the message or opt out.",
    "agents.form.repeatDigit": "Repeat digit",
    "agents.form.repeatMessage": "Repeat message",
    "agents.form.maxRepeats": "Max repeats",
    ...
    "agents.form.dtmfDigitFormat": "Must be a single digit (0-9).",
    "agents.form.repeatDigitPlaceholder": "1",
    "agents.form.repeatMessagePlaceholder": "To hear this message again, press 1.",
    "agents.form.maxRepeatsPlaceholder": "2",
    ...
    "agents.form.allowUserBargeIn": "Let the caller interrupt the agent while it speaks",
    "agents.detail.allowUserBargeIn": "Allow interruptions",
    "agents.detail.yes": "Yes",
    "agents.detail.no": "No",
    "agents.form.idleInvalid":
      "Enter an idle prompt, a timeout of at least 3000 ms, and at least 1 idle timeout.",
    "agents.lang.es-419": "Spanish (Latin America)",
    "agents.lang.multi": "Multilingual (callers mix languages)",
    ...
    "gestiones.filter.allDeliveries": "All deliveries",
    "gestiones.filter.allOutcomes": "All results",
    "gestiones.filter.allAgents": "All channels",
    "gestiones.empty": "No activity recorded yet.",
    "gestiones.delivery.DISPATCHED": "Dispatched",
    "gestiones.delivery.DELIVERED": "Delivered",
    "gestiones.delivery.FAILED": "Failed",
    // A call is "connected", not "delivered" — same enum value, channel-appropriate word.
    "gestiones.delivery.voice.DELIVERED": "Connected",
    "gestiones.deliveryReason.NO_ANSWER": "No answer",
    "gestiones.deliveryReason.BUSY": "Busy",
    "gestiones.deliveryReason.UNREACHABLE": "Unreachable",
    "gestiones.deliveryReason.PROVIDER_ERROR": "Provider error",
    ...
    "gestiones.outcome.WRONG_PARTY": "Wrong party",
    ...
    "gestiones.detail.gestionId": "Gestión ID",
    "gestiones.detail.copyId": "Copy ID",
    "gestiones.detail.idCopied": "Copied",
    "gestiones.detail.phone": "Phone",
    "gestiones.detail.email": "Email",
    "gestiones.col.delivery": "Delivery",
    ...
    "gestiones.detail.recordingUnavailableExplanation":
      "The call recording was not captured for this attempt.",
    ...
    "apiKeys.create.expiresAtLabel": "Expiration (optional)",
    "apiKeys.create.expiresAtError": "Expiration must be in the future.",
  ...
  es: {
    ...
    "home.contactRate.periodAriaLabel": "Período de tasa de contacto",
    // Deliberadamente corto: "cuentas alcanzadas" se corta dentro del ancho de la tarjeta.
    // La etiqueta de la tarjeta ya deja claro que esto es una tasa de contacto.
    "home.contactRate.subline": "{contacted} de {total} cuentas · {sends} envíos",
    "home.contactRate.empty": "Sin envíos en el período",
    "home.contactRate.emptyValue": "—",
    ...
    "forgotPassword.sentTitle": "Revisa tu correo",
    "forgotPassword.sentSubtitle":
    ...
    "resetPassword.title": "Crea una nueva contraseña",
    "resetPassword.subtitle": "Debe tener al menos 8 caracteres.",
    ...
    "resetPassword.invalidTitle": "Enlace inválido o expirado",
    "resetPassword.invalidSubtitle": "Solicita un nuevo enlace para restablecer tu contraseña.",
    "resetPassword.invalidCta": "Volver a solicitar enlace",
    ...
    "billing.subtitle": "Cr\u00e9ditos, plan y pago de este espacio de trabajo.",
    "billing.cycleCredits": "Cr\u00e9ditos del ciclo",
    "billing.remaining": "US$ {balance} de US$ {allowance} restantes",
    "billing.renews": "Se renueva el {date}",
    "billing.projectedDays": "\u2248 {days} d\u00edas m\u00e1s",
    "billing.planAndPayment": "Plan y pago",
    "billing.managePlan": "Gestionar plan",
    "billing.updatePayment": "Actualizar m\u00e9todo de pago",
    "billing.viewInvoices": "Ver facturas",
    "billing.stripeNote":
      "Las facturas y los m\u00e9todos de pago se gestionan de forma segura en Stripe.",
    "billing.disabled": "La facturaci\u00f3n no est\u00e1 habilitada en este despliegue.",
    "billing.notEnrolled": "Este espacio de trabajo a\u00fan no tiene un plan.",
    "billing.choosePlan": "Elegir un plan",
    "billing.currentPlan": "Plan actual",
    "billing.upgradeNow": "Mejorar ahora",
    "billing.downgrade": "Bajar de plan",
    "billing.upgradeNote": "Se aplica de inmediato \u00b7 cr\u00e9ditos prorrateados",
    "billing.downgradeNote": "Se aplica al final del ciclo",
    "billing.downgradeScheduled":
    ...
    "billing.paused.exhausted.body":
      "Los env\u00edos se reanudan cuando se renueve el ciclo \u00b7 o de inmediato si mejoras el plan.",
    "billing.paused.exhausted.cta": "Mejorar plan",
    "billing.paused.paymentFailed.title": "Cobranzas pausadas \u00b7 problema con el pago",
    "billing.paused.paymentFailed.body":
      "Actualiza el m\u00e9todo de pago para reanudar los env\u00edos \u00b7 no es necesario cambiar de plan.",
    "billing.paused.paymentFailed.cta": "Actualizar m\u00e9todo de pago",
    ...
    "profile.field.appearance": "Apariencia",
    ...
    "profile.password.subtitle": "Debe tener al menos 8 caracteres.",
    "profile.password.newPassword": "Nueva contraseña",
    "profile.password.confirmPassword": "Confirmar contraseña",
    "profile.password.save": "Actualizar contraseña",
    "profile.password.saving": "Actualizando…",
    "profile.password.saved": "Contraseña actualizada",
    "profile.password.saveError": "No se pudo actualizar la contraseña.",
    ...
    "members.viewerNotice": "Tienes acceso de solo lectura a los miembros de este espacio.",
    ...
    "portfolios.col.lastSynced": "Última sincronización",
    "portfolios.lastSynced.never": "Nunca sincronizada",
    ...
    "portfolios.reachOut.whatsAppReadOnly":
      "Plantilla aprobada por Meta con los valores de este cliente completados. El texto no se puede editar.",
    ...
    "agents.form.dtmfSectionDescription":
      "El destinatario puede presionar un dígito durante la llamada para repetir el mensaje o darse de baja.",
    "agents.form.repeatDigit": "Dígito para repetir",
    "agents.form.repeatMessage": "Mensaje de repetición",
    "agents.form.maxRepeats": "Máximo de repeticiones",
    ...
    "agents.form.dtmfDigitFormat": "Debe ser un solo dígito (0-9).",
    "agents.form.repeatDigitPlaceholder": "1",
    "agents.form.repeatMessagePlaceholder": "Para escuchar este mensaje de nuevo, presione 1.",
    "agents.form.maxRepeatsPlaceholder": "2",
    "agents.form.optOutDigitPlaceholder": "9",
    ...
    "agents.form.idleTimeoutPlaceholder": "8000",
    "agents.form.idleMaxTimeoutCountPlaceholder": "3",
    "agents.form.allowUserBargeIn": "Permitir que el cliente interrumpa al agente mientras habla",
    "agents.detail.allowUserBargeIn": "Permitir interrupciones",
    "agents.detail.yes": "Sí",
    "agents.detail.no": "No",
    "agents.form.idleInvalid":
      "Ingrese un mensaje de inactividad, un tiempo de al menos 3000 ms y al menos 1 reintento.",
    "agents.lang.es-419": "Español (Latinoamérica)",
    "agents.lang.multi": "Multilingüe (el cliente mezcla idiomas)",
    ...
    "gestiones.filter.allDeliveries": "Todas las entregas",
    ...
    "gestiones.delivery.DISPATCHED": "Despachado",
    "gestiones.delivery.DELIVERED": "Entregado",
    "gestiones.delivery.FAILED": "Fallido",
    // Una llamada se "conecta", no se "entrega" — mismo valor, palabra propia del canal.
    "gestiones.delivery.voice.DELIVERED": "Conectada",
    "gestiones.deliveryReason.NO_ANSWER": "Sin respuesta",
    "gestiones.deliveryReason.BUSY": "Ocupado",
    "gestiones.deliveryReason.UNREACHABLE": "Inalcanzable",
    "gestiones.deliveryReason.PROVIDER_ERROR": "Error del proveedor",
    ...
    "gestiones.outcome.WRONG_PARTY": "Persona equivocada",
    ...
    "gestiones.detail.recordingUnavailableExplanation":
      "La grabación de la llamada no se capturó para este intento.",
    ...
    "apiKeys.create.expiresAtLabel": "Fecha de expiración (opcional)",
    "apiKeys.create.expiresAtError": "La expiración debe ser una fecha futura.",
