...
export const Error: Story = {
  args: {
    ...
    description:
      "Rover telemetry signal interrupted. Check your base antenna alignment or retry connection in 10 minutes."
  }
};
...
export const Info: Story = {
  args: {
    ...
    description: "AI agent integration is now available for your account."
  }
};
