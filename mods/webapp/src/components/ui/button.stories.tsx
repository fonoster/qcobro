...
export const WithIcon: Story = { args: { children: <><Plus className="h-4 w-4" /> Button</> } };
...
export const IconButtons: Story = {
  render: () => (
    <div className="flex flex-wrap gap-3">
      ...
      <IconButton variant="secondary"><Download className="h-4 w-4" /></IconButton>
      <IconButton variant="outline"><Download className="h-4 w-4" /></IconButton>
      <IconButton variant="ghost"><Download className="h-4 w-4" /></IconButton>
      <IconButton variant="destructive"><Trash2 className="h-4 w-4" /></IconButton>
      <IconButton size="lg"><Plus className="h-5 w-5" /></IconButton>
    </div>
  )
};
