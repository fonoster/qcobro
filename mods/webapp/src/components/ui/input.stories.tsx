...
export const WithError: StoryObj = {
  render: () => (
    <div className="w-72">
      <InputGroup label="Email" placeholder="you@example.com" error="Invalid email address" id="email" />
    </div>
  )
};
...
export const WithHint: StoryObj = {
  render: () => (
    <div className="w-72">
      <InputGroup label="Username" placeholder="johndoe" hint="Only letters, numbers, and underscores" id="username" />
    </div>
  )
};
