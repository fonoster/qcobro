...
export function DataTable<T extends Record<string, unknown>>({
  ...
  const pageStart = totalRecords !== undefined ? (page - 1) * Math.ceil(totalRecords / totalPages || 1) + 1 : 1;
  const pageEnd = totalRecords !== undefined ? Math.min(page * Math.ceil(totalRecords / totalPages || 1), totalRecords) : data.length;
